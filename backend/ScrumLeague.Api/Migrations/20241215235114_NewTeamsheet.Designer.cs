...
namespace ScrumLeague.Api.Migrations
{
    ...
    [Migration("20241215235114_NewTeamsheet")]
    partial class NewTeamsheet
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScrumLeague.Models.TeamsheetPlayer", b =>
                {
                    b.HasOne("ScrumLeague.Models.Player", "Player")
                        .WithMany()
                        .HasForeignKey("PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ScrumLeague.Models.Teamsheet", "Teamsheet")
                        .WithMany("Players")
                        .HasForeignKey("TeamsheetId");

                    b.Navigation("Player");

                    b.Navigation("Teamsheet");
                });
